"""
Graphing utilities for training curve analysis and scaling law fitting.

Exports:
    TrainingCurveAnalyzer - main class for loading CSVs, computing Pareto frontiers,
                            fitting power laws, and plotting scaling curves.
    FONT_CONFIG   - default font sizes for plots
    ALPHA_CONFIG  - default transparency values for plot elements
    IRREDUCIBLE_LOSS - baseline irreducible loss constant
    CLASS_COLORS  - default color mapping for experiment classes
"""
import pandas as pd
import numpy as np
    ...
    def plot_training_curves_by_class(
        ...
        if show_power_law_fit:
            ...
            for cls in classes_to_plot:
                ...
                linestyle = "--"
                class_color = self.get_class_color(cls)
                ...
                if show_legend:
                    ...
                    ax.text(
                        ...
                        eq_y,
                        equation_text,
                        fontsize=FONT_CONFIG["equation_size"],
                        color="black",
                        weight="bold",
                        ha="center",
                        va="bottom",
        ...
        if target_loss_line is not None and show_power_law_fit:
            ...
            if len(compare_classes) == 2:
                ...
                fit_results = self.fit_power_law_by_class(
                    class_names=compare_classes, use_all_points=use_all_points
                )
                ...
                if len(intersections) == 2:
                    ...
                    if (
                        ...
                        ax.annotate(
                            ...
                            fontsize=FONT_CONFIG["multiplier_size"],
                            color="black",
                            weight="bold",
                            ha="center",
                            va="bottom",
        ...
        # Position legend (only if show_legend is True)
        if show_legend:
            leg = ax.legend(
