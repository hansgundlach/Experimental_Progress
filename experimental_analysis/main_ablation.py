...
gelu_relu_estimate = compute_multiplier_estimate_by_loss(
    "stanford_mult/64d_gelu", "stanford_mult/64d_relu", target_loss=TARGET_LOSS
)
...
post_pre_norm_estimate = compute_multiplier_estimate_by_loss(
    "stanford_mult/64d_rms", "stanford_mult/64d_post", target_loss=TARGET_LOSS
)
print(post_pre_norm_estimate)

rms_vs_layer_estimate = compute_multiplier_estimate_by_loss(
    "stanford_mult/64d_rms", "stanford_mult/64d_layer", target_loss=TARGET_LOSS
)
...
cosine_inverse_sqrt_estimate = compute_multiplier_estimate_by_loss(
    "stanford_mult/64d_rms",
    "stanford_mult/64d_lr_inverse_sqrt",
    target_loss=TARGET_LOSS,
)
...
estimates_data = [
    ...
    ("Transformer vs LSTM", lstm_modern_transformer_estimate),
