...
if __name__ == "__main__":
    ...
    experiments_config = [
        ...
        # sgd scaling further
        {
            ...
            "csv_path": "../experimental_data_folder/sgd_scaling/swiglu_32d_sgdbs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "sgd",
            "hidden_dim": 32,
        },
        {
            ...
            "csv_path": "../experimental_data_folder/sgd_scaling/swiglu_48d_sgdbs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "sgd",
        ...
        },
        {
            ...
            "csv_path": "../experimental_data_folder/sgd_scaling/swiglu_64d_sgdbs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "sgd",
        ...
        },
        {
            ...
            "csv_path": "../experimental_data_folder/sgd_scaling/swiglu_96d_sgdbs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "sgd",
            "hidden_dim": 96,
        },
        {
            ...
            "csv_path": "../experimental_data_folder/sgd_scaling/swiglu_128d_sgdbs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "sgd",
            "hidden_dim": 128,
        },
        {
            ...
            "csv_path": "../experimental_data_folder/sgd_scaling/swiglu_160d_sgdbs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "sgd",
            "hidden_dim": 160,
        ...
        {
            "name": "192 sgd scaling further",
            "csv_path": "../experimental_data_folder/sgd_scaling/swiglu_192d_sgdbs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "sgd",
            "hidden_dim": 160,
        ...
        # look at scaling of 2017 transfomere
        {
            ...
            "csv_path": "../experimental_data_folder/retry_historical_experiments/t_newold_32transformer_2017_bs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
        ...
        },
        {
            ...
            "csv_path": "../experimental_data_folder/retry_historical_experiments/t_newold_p48transformer_2017_bs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "2017 Transformer",
            "hidden_dim": 48,
        ...
        #     "csv_path": "../experimental_data_folder/historical_experiments/newold_64transformer_2017_bs64.csv",
        #     "marker": "o",
        #     "include_in_frontier": True,  # Include in frontier analysis
        #     "class": "2017 Transformer",
        #     "hidden_dim": 64,
        ...
        # 80 96 128
        {
            ...
            "csv_path": "../experimental_data_folder/retry_historical_experiments/t_newold_p80transformer_2017_bs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "2017 Transformer",
            "hidden_dim": 80,
        },
        {
            ...
            "csv_path": "../experimental_data_folder/retry_historical_experiments/t_newold_p96transformer_2017_bs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "2017 Transformer",
            "hidden_dim": 96,
        },
        {
            ...
            "csv_path": "../experimental_data_folder/retry_historical_experiments/t_newold_p128transformer_2017_bs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "2017 Transformer",
            "hidden_dim": 128,
        },
        {
            ...
            "csv_path": "../experimental_data_folder/retry_historical_experiments/t_newold_p160transformer_2017_bs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "2017 Transformer",
            "hidden_dim": 160,
        ...
        # 256
        {
            ...
            "csv_path": "../experimental_data_folder/retry_historical_experiments/t_newold_p256transformer_2017_bs64.csv",
            "marker": "o",
            "include_in_frontier": True,  # Include in frontier analysis
            "class": "2017 Transformer",
            "hidden_dim": 256,
    ...
    class_legend_mapping = {
        ...
        "radford transformer": "Radford Transformer experiments",
    }
